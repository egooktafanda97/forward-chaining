...
<head>
	<title>Login | Sistem Pakar Diagnosa Penyakit Pada KLINIK ALQASHA</title>
	<meta charset="UTF-8">
			...
			<div class="wrap-login100">
				<section class="login100-form validate-form">
					<span class="login100-form-title p-b-34" style="font-family: arial">
						Sistem Pakar Diagnosa Penyakit Pada KLINIK ALQASHA<br>
					...
					<div class="w-full text-center p-t-27 p-b-239">
						...
						<a href="http://localhost:8080/sistem_pakar" target="_blank" class="txt2" style="color: #3EA8FF" style="font-family: arial">
							Kembali ke Halamnan Utama
						</a>
					</div>
				...
				<div class="login100-more" style="background-image: url('<?php echo base_url() ?>assets/templatelogin/images/bg-02.png');"></div>
			</div>
		</div>
	</div>
