					...
					<nav class="navbar navbar-expand-lg  navbar-light">
						<div class="container">
							<a class="navbar-brand" href="">
								<img src="<?php echo base_url() ?>assets/production/images/logook.png" alt="" style="width: 50px; height: 50px;">
							</a> <span style="color: black">SISTEM PAKAR DIAGNOSA PENYAKIT PADA KLINIK ALQASHA</span>
