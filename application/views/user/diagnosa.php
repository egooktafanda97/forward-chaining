		...
		<div class="row d-flex justify-content-center">
			<div class="menu-content pb-60 col-lg-6">
				<div class="title text-center">
					...
					<!-- <h2>Penyakit Tanaman Padi</h2> -->
					<p>Halaman ini adalah halaman diagnosa, Silahkan anda memilih gejala dengan cara mencentang beberapa pilihan dibawah ini sesuai dengan Gejala, Terima Kasih.</p>
				</div>
			</div>
		</div>
		<div class="row d-flex justify-content-center">
