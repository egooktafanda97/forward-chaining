        ...
        <div class="box-body">
            <table id="tbl-list" class="table table-bordered">
                <tr>
                    ...
                    <th style="background: #67CDFF; color: white">Persentase</th>
                </tr>
                <tr>
                    <?php $i = 1;
    ...
    <div class="box box-success">
        ...
        <div class="box-body">
            <?php if (sizeof($listPenyakit) > 0) { ?>
                <p>
                    Berdasarkan gejalanya, Pasien Anda terserang <b><?php echo $listPenyakit[0]['nama']; ?></b> dengan Persentase <b><?php echo $listPenyakit[0]['kepercayaan']; ?> %</b><br />
                    <?php echo $listPenyakit[0]['keterangan']; ?>.
                <p style="font-style: bold; color: red; font-size: 13px;">*Hasil diagnosa ini masih membutuhkan pemeriksaan lebih lanjut, untuk mendapatkan hasil yang lebih akurat.</p>
                </p>
            <?php } else { ?>
                <p>
